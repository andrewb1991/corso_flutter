...
//     return Scaffold(
//       appBar: AppBar(
//           title: Text('${prodotti.product}',style: TextStyle(color: Colors.blue)),
//           centerTitle: true,
//           actions: [
//             IconButton(
...
//                   context,
//                  PageTransition(
//                   type: PageTransitionType.rightToLeftWithFade, // oppure .fade, .scale, ecc.
//                   child: EditProductPage(product: prodotti),
